...
<th scope="col"><a href='get_orders_list_new.php'>打印上周订单(<?php echo date("ymd",$start)."-".date("ymd",$end)?>)</a></th><th scope="col">只打印上一周的订单，不改变用户的状态，可重复打印（包括付款完成或者已经发送的订单）</th></tr>
<th scope="col"><a href='get_orders_list_new.php?op=latest'>打印截至本周五的所有订单(<?php echo $time ?>)</a></th><th scope="col">打印截至本周五的所有订单，不改变用户的状态，可重复打印（包括付款完成或者已经发送的订单）</th></tr>
